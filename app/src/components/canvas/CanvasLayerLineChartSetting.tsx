...
const CanvasLayerLineChartSetting: CanvasLayerSettingComponent<
  any,
  CanvasLineChartConfig
> = ({ layer }) => {
      ...
      <DescriptionItem
        ...
        content={
          <Checkbox
            ...
            onChange={(e) =>
              handleUpdateConfig("gridColumnsMode", e.target.checked)
            }
          />
        }
      />
          ...
          <DescriptionItem
            ...
            content={
              <InputNumber
                ...
                onChange={(value) =>
                  handleUpdateConfig("annotationContainerWidth", value)
                }
              />
            }
          />
          <DescriptionItem
            ...
            content={
              <Input
                ...
                onChange={(e) =>
                  handleUpdateConfig("annotationTitle", e.target.value)
                }
              />
            }
          />
          <DescriptionItem
            ...
            content={
              <Input.TextArea
                ...
                onChange={(e) =>
                  handleUpdateConfig("annotationSubtitle", e.target.value)
                }
              />
            }
          />
