...
import { CanvasLayerSettingComponent, CanvasLineChartConfig } from '@core/models';
...
const CanvasChartAxisSetting: CanvasLayerSettingComponent<CanvasLineChartConfig> = ({ layer }) => {
  ...
  return (
    <div>
      ...
      <DescriptionItem
        ...
        content={
          <SolidColorButton
            value={config.axisStyle?.stroke || GLOBAL_THEME_COLOR.$highlight_color}
